                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group" style="text-align: center">
                                ...
                                <input type="file"  id="photoFile" name="photoFile" accept="img/*" style="display: none;">
                            </div>
                            <form class="forms-sample" name="registerF" id="registerF" accept-charset="utf-8">
                                ...
                                <div style="text-align:center;">
                                    ...
                                    <input type="button" class="btn btn-light" value="회원탈퇴" onclick="location.href='/deleteUser-action';" >
                                </div>
                            </form>
                        </div>
                    </div>
