                                ...
                                <form class="forms-sample" name="registerF" id="registerF" accept-charset="utf-8">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-6">
                                            ...
                                            <input readonly type="text" class="form-control" id="uName" name="uName" value="${user.getUName()}">
                                        </div>
                                        <div class="col-6">
                                            <label for="uGender">성별</label>
                                            <select class="form-control" id="uGender" name="uGender" readonly>
                                                <c:if test="${user.getUGender() == '남'}">
                                                    <option selected>남</option>
                                                    <option>여</option>
                                                </c:if>
                                                <c:if test="${user.getUGender() == '여'}">
                                                    <option>남</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input readonly type="email" class="form-control" id="uEmail" name="uEmail" value="${user.getUEmail()}">
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-6">
                                            <label for="uPhone">전화번호</label>
                                            <input readonly type="text" class="form-control" id="uPhone" name="uPhone" value="${user.getUPhone()}">
                                        </div>
                                        <div class="col-6">
                                            <label >생일</label>
                                            <text readonly class="form-control" id="uBirth" name="uBirth" >
                                            <fmt:formatDate value="${user.getUBirth()}" pattern="yyyy. MM. dd."/>
                                            </text>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-6">
                                            ...
                                            <input readonly type="text" class="form-control" id="uAddress" name="uAddress" value="${user.getUAddress()}">
                                        </div><div class="col-6">
                                            <label for="uAddress2">상세주소</label>
                                            <input readonly type="text" class="form-control" id="uAddress2" name="uAddress2" value="${user.getUAddress2()}">
                                        </div>
                                    </div>
