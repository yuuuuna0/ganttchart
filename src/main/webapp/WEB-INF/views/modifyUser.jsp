                                    ...
                                    <tr>
                                        ...
                                        <form method="POST" action="register-action" accept-charset="utf-8" >
                                            <td>
                                                ...
                                                <div class="mt-4 mb-0">
                                                    <div class="d-grid">
                                                        <button class="btn btn-primary btn-block" onclick="location.href='modifyUser/${loginUser.id}'">Modify</button>
                                                    </div>
                                                </div>
                                                <div class="mt-4 mb-0">
                                                    <div class="d-grid">
                                                        <button class="btn btn-primary btn-block" onclick="location.href='deleteUser-action/${loginUser.id}'">Withdrawal account</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </form>
